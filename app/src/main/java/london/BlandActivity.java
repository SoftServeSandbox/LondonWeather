...
import com.example.administrator.julia_project.R;
...
public class BlandActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weather.execute("http://api.openweathermap.org/data/2.5/weather?q=London,uk");
    }
    ...
    public class Weather extends AsyncTask<String, Void, JSONObject>
    {
        ...
        protected void onPostExecute(JSONObject jsonObject) {
            ...
            try {
                ...
                conditions = jsonObject.getJSONObject("weather").getString("main");
                mTemperatureTextView.setText(temperature);
                mWeatherConditionsTextView.setText(conditions);
